					...
					<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Tạo Mới Công Trình</h5>
							...
							<div class="modal-body">
                                <form action="THEM_CONGTRINH_QUANTRIVIEN.php" method="post">
                                    <div class="mb-3 mt-3">
                                        <label for="TenCongTrinh" class="form-label">Tên Công Trình</label>
                                        <input type="text" class="form-control" id="TenCongTrinh" name="TenCongTrinh" required>
                                    </div>
                                    <div class="mb-3 mt-3">
                                        <label for="NguoiQuanLy" class="form-label">Người Quản Lý</label>
										<select class="select" id="NguoiQuanLy" name="NguoiQuanLy">
											<?php
												require_once("ketnoi.php");
												$edit2_sql = "SELECT * FROM nguoidung";

												$result2 = mysqli_query($conn ,$edit2_sql);
												while ($r2 = mysqli_fetch_assoc($result2)){
											?>
												<option value="<?php echo $r2['ID_NguoiDung'] ?>"><?php echo $r2['HoTen'] ?></option>
											<?php
												}
											?>
                                            </select>
                                    ...
                                    <div class="mb-3 mt-3">
                                        <label for="NgayDuKien" class="form-label">Ngày Dự Kiến Hoàn Thành</label>
                                        <input type="date" class="form-control" id="NgayDuKien" name="NgayDuKien" required>
                                    </div>
									<div class="mb-3 mt-3">
                                        <label for="NganSachDuChi" class="form-label">Ngân Sách Dự Chi</label>
                                        <input type="text" class="form-control" id="NganSachDuChi" name="NganSachDuChi" required>
                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="XEM_THEODOICONGTRINH_QTV.PHP?sid=<?php echo $r['ID_CongTrinh']; ?>"><?php echo $r['ID_CongTrinh'] ?></a>
                                                </h2>
                                            </td>
                                            <td>
												<h2 class="table-avatar">
													<a href="XEM_THEODOICONGTRINH_QTV.PHP?sid=<?php echo $r['ID_CongTrinh']; ?>"><?php echo $r['TenCongTrinh'] ?></a>
                                                </h2>
                                            </td>
											<td>
											<?php
