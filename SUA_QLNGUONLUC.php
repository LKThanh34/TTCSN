<?php
    ...
    $edit_sql = "SELECT * FROM nguonluc WHERE ID_NguonLuc=$id";
        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<h1 style="margin-top: 20px; margin-bottom: 20px">Form Sửa Nguồn Lực </h1>
					<form action="SUA2_QLNGUONLUC.php" method="post">
						<input type="hidden" name="sid" value="<?php echo $id; ?>" id="">
						<div class="mb-3 mt-3">
							<label for="MaNguonLuc" class="form-label">Mã Nguồn Lực</label>
							<input type="text" class="form-control" id="MaNguonLuc" name="MaNguonLuc" required value="<?php echo $row['MaNguonLuc'] ?>">
						</div>
						<div class="mb-3 mt-3">
							<label for="TenNguonLuc" class="form-label">Tên Nguồn Lực</label>
							<input type="text" class="form-control" id="TenNguonLuc" name="TenNguonLuc" required value="<?php echo $row['TenNguonLuc'] ?>">
						</div>
						<div class="mb-3 mt-3">
							<div class="form-group">
								<label for="MaCongTrinh" class="form-label">Công Trình</label>
								<select class="select" id="MaCongTrinh" name="MaCongTrinh" value="<?php echo $row['FK_ID_TienDo'] ?>">
									<option value="#">...</option>
									<?php
										require_once("ketnoi.php");
						...
						<div class="mb-3 mt-3">
							...
							<select class="select" id="LoaiNguonLuc" name="LoaiNguonLuc" value="<?php echo $row['LoaiNguonLuc'] ?>">
								<option value="#">...</option>
						...
						<div class="mb-3 mt-3">
							...
							<input type="text" class="form-control" id="TrangThai" name="TrangThai"required value="<?php echo $row['TrangThai'] ?>">
						</div>
						<div class="mb-3 mt-3">
							<label for="MoTa" class="form-label">Mô Tả</label>
							<input type="text" class="form-control" rows="3" id="MoTa" name="MoTa" value="<?php echo $row['MoTa'] ?>">
						</div>
						<div class="mb-3 mt-3">
							<label for="ThongTinKhac" class="form-label" >Thông Tin Khác</label>
							<input type="text" class="form-control" rows="3" id="ThongTinKhac" name="ThongTinKhac" value="<?php echo $row['ThongTinKhac'] ?>">
						</div>
