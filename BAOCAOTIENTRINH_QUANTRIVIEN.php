                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Tạo Báo Cáo Tiến Trình</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
									<li class="breadcrumb-item active">Báo Cáo Tiến Trình</li>
								</ul>
							</div>
							<div class="col-auto float-right ml-auto">
								<a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_salary"><i class="fa fa-plus"></i>Tạo Báo Cáo</a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
					...
					<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
                                <form action="THEM_BAOCAOTIENTRINH_QUANTRIVIEN.php" method="post">
                                    <div class="mb-3 mt-3">
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="XEM_BAOCAOTIENTRINH_QUANTRIVIEN.PHP?sid=<?php echo $r['ID_BaoCao']; ?>"><?php echo $r['TenBaoCao'] ?></a>
                                                </h2>
                                            </td>
                                            <td>
                                                <a><?php echo $r['LoaiBaoCao'] ?></a>
                                            </td>
                                            <td>
                                                <a><?php echo $r['Ngay'] ?></a>
                                            </td>
